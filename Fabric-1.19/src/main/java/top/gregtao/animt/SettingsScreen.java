...
public class SettingsScreen extends Screen {
    ...
    public SettingsScreen() {
        super(Text.translatable("animt.screen.title"));
    }
    ...
    public void saveToConfig(RecorderConfig config) {
        ...
        if (this.client != null && this.client.player != null) {
            this.client.player.sendMessage(Text.translatable("animt.screen.save"));
        }
    }
    ...
    protected void init() {
        ...
        this.addDrawableChild(new ButtonWidget(
                ...
                Text.translatable("animt.button.reset"), button -> this.resetToDefault()));

        this.addDrawableChild(new ButtonWidget(
                this.width / 2 + 100, 65, 60, 20,
                Text.translatable("animt.button.save"), button -> this.saveToConfig(EntityRecorder.CURRENT.config)));

        this.addDrawableChild(new ButtonWidget(
                this.width / 2 + 100, 85, 60, 20,
                Text.translatable("animt.button.save_file"),
                button -> {
        ...
        this.addDrawableChild(new ButtonWidget(
                ...
                Text.translatable("animt.button.open_folder"),
        ...
        this.typeWidget = CyclingButtonWidget
                ...
                .build(10, 185, 110, 20, Text.translatable("animt.button.types"));
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        this.textRenderer.draw(matrices, Text.translatable("animt.screen.trans"), 140, 192, 0xffffff);
