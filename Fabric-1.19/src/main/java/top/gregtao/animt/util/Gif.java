...
/*
https://blog.csdn.net/u013314786/article/details/102641073, with something changed
*/
public class Gif {
    ...
    public static void convert(BufferedImage[] images, String gifPath, int delay, boolean loop, Integer width, Integer height) {
        try {
            ...
            FileHelper.existOrCreateWithParent(gif);
            FileImageOutputStream fileImageOutputStream = new FileImageOutputStream(gif);
            convert(images, fileImageOutputStream, delay, loop, width, height);
        } catch (Exception e) {
            throw new RuntimeException("GIF convert error", e);
        }
