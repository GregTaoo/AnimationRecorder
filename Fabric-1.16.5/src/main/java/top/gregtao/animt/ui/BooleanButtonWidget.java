...
public class BooleanButtonWidget extends ButtonWidget {
    private boolean bl;
    private final MutableText trueText = new TranslatableText("animt.button.bl.true");
    private final MutableText falseText = new TranslatableText("animt.button.bl.false");
    ...
    public static void onClickedLambda(ButtonWidget button) {
        if (button instanceof BooleanButtonWidget) {
            BooleanButtonWidget widget = (BooleanButtonWidget) button;
            widget.changeValue();
        }
    }
