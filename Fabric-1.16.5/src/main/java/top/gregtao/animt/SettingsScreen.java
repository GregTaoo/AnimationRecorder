...
public class SettingsScreen extends Screen {
    ...
    public void loadFromConfig(RecorderConfig config) {
        ...
        this.imageType = config.type;
        this.typeWidget.setMessage(this.imageType.getMessage());
    }
    ...
    protected void init() {
        ...
        this.colorField.forEach(this.children::add);

        this.typeWidget = new ButtonWidget(
                10, 185, 110, 20,
                new TranslatableText("animt.button.types"),
                button -> {
                    this.imageType = ImageFileType.getByIndex(this.imageType.ordinal() + 1);
                    this.typeWidget.setMessage(this.imageType.getMessage());
                });
        this.addButton(this.typeWidget);
