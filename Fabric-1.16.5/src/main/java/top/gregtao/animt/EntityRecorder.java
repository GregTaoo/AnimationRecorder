...
public class EntityRecorder {
    ...
    public static LivingEntity getTargetedEntity(MinecraftClient client) {
        if (client.targetedEntity instanceof LivingEntity) {
            return (LivingEntity) client.targetedEntity;
        }
        return null;
    }
    ...
    public void bindTarget(MinecraftClient client, LivingEntity tg) {
        ...
        if (tg == null) {
            ...
            this.target = tg;
            player.sendMessage(new TranslatableText("animt.bind_target", tg.getDisplayName().getString()), false);
        }
    }
    ...
    public void recorderPreset() {
        ...
        this.player.sendMessage(new TranslatableText("animt.record_started", this.target.getDisplayName().getString()), false);
    ...
    public static void rotateModelStack(float x, float y, float z) {
        ...
        RenderSystem.rotatef(y, 0, 1, 0);
        RenderSystem.rotatef(x, 1, 0, 0);
        RenderSystem.rotatef(z, 0, 0, 1);
    }
